...
async function createCourse() {
  try {
    const course = await Course.create({
      courseName: "gaurav course", description: "pankaj course is going on", author: "gaurav one", authorImage: "fucking iamge", thumbnail: "sfds", subCourse: [{ title: "something title", videos: [{ video: "60104e4f6a400b28c43bfd31" }] }, {
